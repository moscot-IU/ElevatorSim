...
Represents the structure of the elevator’s operations. It explains the available floors and provides the movement. 
  2.	Elevator: Nickolas Macy 
Has core functions and operations for the elevator. This includes the direction of movement between floors, and which position the elevator is sitting in, and direction of travel. 
  3.	ElevatorController: Kendall Ferguson
This manages the incoming requests from the user and makes the decision on how to respond in correlation. This is considered the decision making process. 
  4.	Request: Madilynn Foley
Represents a user’s request, including the floor they selected and the direction (up or down).
